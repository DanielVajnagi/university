...
public class Magazine : Edition, IRateAndCopy {
    ...
    private ArrayList _editors = default!;
    private ArrayList _articles = default!; 
    
    public Frequency PublicationFrequency { get => _frequency; init => _frequency = value; }
    public ArrayList Editors { get => _editors; private init => _editors = value; }
    public ArrayList Articles { get => _articles; private init => _articles = value; }
    ...
    public override object DeepCopy() {
        ...
        ArrayList articlesCopy = (ArrayList) Articles.Clone();
        foreach (Article article in articlesCopy) {
            copyInstance.AddArticles((Article) article.DeepCopy());   
        }
        
        ArrayList editorsCopy = (ArrayList) Editors.Clone();
